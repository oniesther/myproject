        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
         ...
         <?php include('message.php'); ?>
            ...
            <div class="card-body p-0">
                ...
                <div class="row">
                    <div class="col-lg-5 d-none d-lg-block bg-register-image"><img src="assets/images/Phones/phone2.png"/></div>
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4 fs-1">Create an Account!</h1>
                            </div>
                            <form  action="registercom.php" method="POST">
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0"> 
                                        <label>First Name</label>
                                        <input type="text" class="form-control form-control-user mt-1" id="exampleFirstName"
                                ...
                                <div class="form-group mt-2">
                                    <label>Email</label>
                                    <input type="email" class="form-control form-control-user mt-1" id="exampleInputEmail"
                                ...
                                <div class="form-group row mt-2">
                                    ...
                                    <div class="col-sm-6 mt-2">
                                        ...
                                        <input type="password" class="form-control form-control-user mt-1"
                                            id="exampleRepeatPassword" placeholder="Comfirm Password" name="cpassword" required>
                                    </div>
                                </div>
                                  <button type="submit" class="btn btn-primary w-50 mt-2" name="signup">Sign up</button>
                            </form>
                            <hr>
                            <div class="text-center">
