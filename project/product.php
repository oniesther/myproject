...
<body>
    <div class="topnavbar" style="background-color: rgb(0, 140, 255); height: 30px;">
        <div class="text-center "><a href="" style="color:#fff; text-decoration: none;">Get free delivery nation or pickup
                in store</a></div>
        ...
        <div class="container-fluid">
            ...
            <li class="nav-item dropdown" id="box" style="list-style: none;">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown" id="drop" style="list-style-type: none;">
                    <li><a class="dropdown-item fs-6" id="drop" href="mac.php" style="list-style: none;">Macbook Pro|M1
                            Pro<br>chip</a></li>
            ...
            </ul><a class="text-decoration-none" href="#">
    ...
    <!-- Offset -->
    <div class="offcanvas offcanvas-end text-center" tabindex="-1" id="offcanvasRight"
    ...
    <div class="container mt-5">
        ...
        <p class="fw-light breadcrumb_link"> <a href="index.html">Home</a> <i class="fas fa-arrow-right"></i> Hera
            Braided Solo Loop Strap Compatible With Apple Watch Band 44mm </p>

        <div class="row">

            <div class="col-lg-6 mb-3 ">
                <img src="./imgis/access_1b.png" alt="" height="300px">
            </div>

            <div class="col-lg-6 d-flex flex-column align-self-center">
                <h5 class="name mb-4">Hera Braided Solo Loop Strap Compatible With Apple Watch Band 44mm</h5>
                <p>₦12,000.00</p>
                ...
                <div class="row my-5">
                    ...
                    <div class="col-6">
                        <button class="btn btn-primary w-100"><i class="fas fa-shopping-cart cart"></i> Add to
                            cart</button>
                    </div>
                </div>

                <p class="fw-bold mb-1">Elastics Material</p>
                <p class="fw-light">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Rerum magni quam vero
                    minus tempore, enim repellendus, libero reprehenderit dicta natus quis unde dolorum in iusto
                    voluptatem beatae ullam numquam alias asperiores. Quis voluptatibus deserunt ea laborum voluptatum.
                    Repellendus ab debitis omnis perferendis atque, ipsum nemo perspiciatis, culpa necessitatibus
                    dolores illo?.</p>
            </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-3 mb-3">
                    <img style="width: 140px;" src="./imgis/authorise.png" alt="">
